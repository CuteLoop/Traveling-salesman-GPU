...
variants: dirs $(ISLAND_BANKCONFLICT_BIN) $(ISLAND_BITSET_BIN)

all_cuda_versions: dirs $(NAIVE_BIN) $(HYBRID_BIN) $(ISLAND_BIN) $(ISLAND_BANKCONFLICT_BIN) $(ISLAND_BITSET_BIN) $(B1_STRIDE_BIN) $(B2_BITMASK_BIN) $(B3_REDUCE_BIN) $(B3_SHUFFLE_BIN) $(B4_GLOBAL_BIN) $(B4_SMEM_BIN)
